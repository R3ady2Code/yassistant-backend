...
class TelegramUpdateParser
{
    ...
    private function parseMessage(string $channelId, Message $msg): ?IncomingMessageData
    {
        ...
        if (is_array($msg->photo) && count($msg->photo) > 0) {
            return $this->buildData($channelId, $chatId, $senderName, MessageType::Photo, $msg->caption, [
        ...
        if ($msg->voice !== null) {
            return $this->buildData($channelId, $chatId, $senderName, MessageType::Voice, $msg->caption, [
        ...
        if ($msg->video !== null) {
            return $this->buildData($channelId, $chatId, $senderName, MessageType::Video, $msg->caption, [
        ...
        if ($msg->document !== null) {
            return $this->buildData($channelId, $chatId, $senderName, MessageType::Document, $msg->caption, [
        ...
        if ($msg->location !== null) {
            return $this->buildData($channelId, $chatId, $senderName, MessageType::Location, null, [
        ...
        if ($msg->contact !== null) {
            return $this->buildData($channelId, $chatId, $senderName, MessageType::Contact, null, [
        ...
        if ($msg->sticker !== null) {
            return $this->buildData($channelId, $chatId, $senderName, MessageType::Sticker, $msg->sticker->emoji ?? null, [
        ...
        if ($msg->text !== null) {
            return $this->buildData($channelId, $chatId, $senderName, MessageType::Text, $msg->text, null);
        }
    ...
    private function parseCallbackQuery(string $channelId, CallbackQuery $cbq): ?IncomingMessageData
    {
        ...
        return $this->buildData($channelId, $chatId, $senderName, MessageType::CallbackQuery, $cbq->data ?? null, [
